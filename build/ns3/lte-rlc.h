...
public:
  ...
  void SetImsi (uint16_t imsi); //sjkang
  ...
  //void SetRandomAccessFinishIndication( bool);
  //bool GetRandomAccessFinishIndication ();
  /**
   *
   *
...
protected:
 ...
 // uint16_t m_rnti; //sjkang1115
  ...
  //bool isFinishRandomAccess; //sjkang
