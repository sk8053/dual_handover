...
public:
	...
	bool isAdditionalUePhy=false; //sjkang
	void SetStreamForMeasuringSinr(std::ofstream *stream, std::ofstream * streamForTbSize); //sjkang
...
private:
	...
	std::ofstream *streamForTbSize; //sjkang0815
