...
void
LteRlc::SetDrbId(uint8_t drbid){ //sjkang1115
	m_drbId = drbid;//sjkang1115

}
void
LteRlc::SetStreamForQueueStatistics(std::ofstream *stream){
...
void
LteRlc::SetLteRlcAssistantSapUser(LteRlcSapUser *s){
...
void
LteRlcSm::DoRequestAssistantInfo(){
