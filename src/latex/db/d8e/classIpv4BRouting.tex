\hypertarget{classIpv4BRouting}{}\section{Ipv4\+B\+Routing Class Reference}
\label{classIpv4BRouting}\index{Ipv4\+B\+Routing@{Ipv4\+B\+Routing}}
...
\index{Ipv4\+B\+Routing@{Ipv4\+B\+Routing}!Notify\+Add\+Address@{Notify\+Add\+Address}}
\index{Notify\+Add\+Address@{Notify\+Add\+Address}!Ipv4\+B\+Routing@{Ipv4\+B\+Routing}}
\subsubsection[{\texorpdfstring{Notify\+Add\+Address(uint32\+\_\+t interface, Ipv4\+Interface\+Address address)}{NotifyAddAddress(uint32_t interface, Ipv4InterfaceAddress address)}}]{\setlength{\rightskip}{0pt plus 5cm}void Ipv4\+B\+Routing\+::\+Notify\+Add\+Address (
\begin{DoxyParamCaption}
\item[{uint32\+\_\+t}]{interface, }
\item[{{\bf Ipv4\+Interface\+Address}}]{address}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [virtual]}}\hypertarget{classIpv4BRouting_a7467acf1e9b8c96d0267233485a5a31b}{}\label{classIpv4BRouting_a7467acf1e9b8c96d0267233485a5a31b}
...
60 \{\}
\end{DoxyCode}
\index{Ipv4\+B\+Routing@{Ipv4\+B\+Routing}!Notify\+Interface\+Down@{Notify\+Interface\+Down}}
\index{Notify\+Interface\+Down@{Notify\+Interface\+Down}!Ipv4\+B\+Routing@{Ipv4\+B\+Routing}}
\subsubsection[{\texorpdfstring{Notify\+Interface\+Down(uint32\+\_\+t interface)}{NotifyInterfaceDown(uint32_t interface)}}]{\setlength{\rightskip}{0pt plus 5cm}void Ipv4\+B\+Routing\+::\+Notify\+Interface\+Down (
\begin{DoxyParamCaption}
\item[{uint32\+\_\+t}]{interface}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [virtual]}}\hypertarget{classIpv4BRouting_ac8ef78a4044ecad2af7ab825b57f0929}{}\label{classIpv4BRouting_ac8ef78a4044ecad2af7ab825b57f0929}
...
59 \{\}
\end{DoxyCode}
\index{Ipv4\+B\+Routing@{Ipv4\+B\+Routing}!Notify\+Interface\+Up@{Notify\+Interface\+Up}}
\index{Notify\+Interface\+Up@{Notify\+Interface\+Up}!Ipv4\+B\+Routing@{Ipv4\+B\+Routing}}
\subsubsection[{\texorpdfstring{Notify\+Interface\+Up(uint32\+\_\+t interface)}{NotifyInterfaceUp(uint32_t interface)}}]{\setlength{\rightskip}{0pt plus 5cm}void Ipv4\+B\+Routing\+::\+Notify\+Interface\+Up (
\begin{DoxyParamCaption}
\item[{uint32\+\_\+t}]{interface}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [virtual]}}\hypertarget{classIpv4BRouting_a6b892a70fc7ceb0bbab43a82a9ff86ff}{}\label{classIpv4BRouting_a6b892a70fc7ceb0bbab43a82a9ff86ff}
...
58 \{\}
\end{DoxyCode}
\index{Ipv4\+B\+Routing@{Ipv4\+B\+Routing}!Notify\+Remove\+Address@{Notify\+Remove\+Address}}
\index{Notify\+Remove\+Address@{Notify\+Remove\+Address}!Ipv4\+B\+Routing@{Ipv4\+B\+Routing}}
\subsubsection[{\texorpdfstring{Notify\+Remove\+Address(uint32\+\_\+t interface, Ipv4\+Interface\+Address address)}{NotifyRemoveAddress(uint32_t interface, Ipv4InterfaceAddress address)}}]{\setlength{\rightskip}{0pt plus 5cm}void Ipv4\+B\+Routing\+::\+Notify\+Remove\+Address (
\begin{DoxyParamCaption}
\item[{uint32\+\_\+t}]{interface, }
\item[{{\bf Ipv4\+Interface\+Address}}]{address}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [virtual]}}\hypertarget{classIpv4BRouting_a683fdaada7e46b27ba90c8debb069916}{}\label{classIpv4BRouting_a683fdaada7e46b27ba90c8debb069916}
...
61 \{\}
\end{DoxyCode}
\index{Ipv4\+B\+Routing@{Ipv4\+B\+Routing}!Print\+Routing\+Table@{Print\+Routing\+Table}}
\index{Print\+Routing\+Table@{Print\+Routing\+Table}!Ipv4\+B\+Routing@{Ipv4\+B\+Routing}}
\subsubsection[{\texorpdfstring{Print\+Routing\+Table(\+Ptr$<$ Output\+Stream\+Wrapper $>$ stream, Time\+::\+Unit unit) const }{PrintRoutingTable(Ptr< OutputStreamWrapper > stream, Time::Unit unit) const }}]{\setlength{\rightskip}{0pt plus 5cm}void Ipv4\+B\+Routing\+::\+Print\+Routing\+Table (
\begin{DoxyParamCaption}
\item[{{\bf Ptr}$<$ {\bf Output\+Stream\+Wrapper} $>$}]{stream, }
\item[{{\bf Time\+::\+Unit}}]{unit}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [virtual]}}\hypertarget{classIpv4BRouting_a4173f33e77b523bf1651fc08e76c3288}{}\label{classIpv4BRouting_a4173f33e77b523bf1651fc08e76c3288}
...
63 \{\}
\end{DoxyCode}
\index{Ipv4\+B\+Routing@{Ipv4\+B\+Routing}!Route\+Input@{Route\+Input}}
\index{Route\+Input@{Route\+Input}!Ipv4\+B\+Routing@{Ipv4\+B\+Routing}}
\subsubsection[{\texorpdfstring{Route\+Input(\+Ptr$<$ const Packet $>$ p, const Ipv4\+Header \&header, Ptr$<$ const Net\+Device $>$ idev, Unicast\+Forward\+Callback ucb, Multicast\+Forward\+Callback mcb, Local\+Deliver\+Callback lcb, Error\+Callback ecb)}{RouteInput(Ptr< const Packet > p, const Ipv4Header &header, Ptr< const NetDevice > idev, UnicastForwardCallback ucb, MulticastForwardCallback mcb, LocalDeliverCallback lcb, ErrorCallback ecb)}}]{\setlength{\rightskip}{0pt plus 5cm}bool Ipv4\+B\+Routing\+::\+Route\+Input (
\begin{DoxyParamCaption}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [virtual]}}\hypertarget{classIpv4BRouting_af9523c1d16620315a75597d18ea03933}{}\label{classIpv4BRouting_af9523c1d16620315a75597d18ea03933}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [virtual]}}\hypertarget{classIpv4BRouting_a69b78371109b582b4b99b1996843c9ed}{}\label{classIpv4BRouting_a69b78371109b582b4b99b1996843c9ed}
...
\end{DoxyCode}
\index{Ipv4\+B\+Routing@{Ipv4\+B\+Routing}!Set\+Ipv4@{Set\+Ipv4}}
\index{Set\+Ipv4@{Set\+Ipv4}!Ipv4\+B\+Routing@{Ipv4\+B\+Routing}}
\subsubsection[{\texorpdfstring{Set\+Ipv4(\+Ptr$<$ Ipv4 $>$ ipv4)}{SetIpv4(Ptr< Ipv4 > ipv4)}}]{\setlength{\rightskip}{0pt plus 5cm}void Ipv4\+B\+Routing\+::\+Set\+Ipv4 (
\begin{DoxyParamCaption}
\item[{{\bf Ptr}$<$ {\bf Ipv4} $>$}]{ipv4}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [virtual]}}\hypertarget{classIpv4BRouting_aa374c6adeaedb07efb307bc4540f7754}{}\label{classIpv4BRouting_aa374c6adeaedb07efb307bc4540f7754}
